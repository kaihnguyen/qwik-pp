  ...
  return (
    <div class="flex flex-col items-center gap-8 py-24">
      <h1 class="text-center text-4xl leading-normal lg:text-5xl">
        <span class="font-extrabold tracking-wide text-primary">Services</span>{' '}
        <span class="font-extrabold tracking-wide text-secondary">Available</span>
      </h1>
          ...
          >
            ...
            <Card.Header>
              ...
              <Card.Description class="text-lg">
                A headles component library of completely unstyled, accessible, and
